...
public class not_Updated_MessageSender extends MessageReceivedEvent{
    ...
    public void sendMessages(String msg, String textchannelid){
        ...
        if (textchannelid != null){
         //   message = guild.getTextChannelById(textchannelid).sendMessage(msg).complete();
        }else {
    ...
    public void sendMessageEmbed(String textchannelid, MessageEmbed... embed){
        if (textchannelid != null){
       //     message = guild.getTextChannelById(textchannelid).sendMessageEmbeds(Arrays.asList(embed)).complete();
       //     guild.getTextChannelById(textchannelid).sendMessageEmbeds(Arrays.asList(embed));
        }else {
